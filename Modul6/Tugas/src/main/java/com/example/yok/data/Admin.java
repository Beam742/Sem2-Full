package com.example.yok.data;

import com.example.yok.LibrarySystem;
import com.example.yok.books.HistoryBook;
import com.example.yok.books.StoryBook;
import com.example.yok.books.TextBook;
import com.example.yok.util.IMenu;
...
//    }
    ...
    public boolean isAdmin(String username, String pass) throws illegalAdminAccess {
